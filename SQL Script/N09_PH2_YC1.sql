...
--CONN NV401/NV401@//localhost:1521/PDB_N09;
--UPDATE N09_ADMIN.N09_NHANSU SET DT = '0123456789' WHERE MANV = 'NV401';
--/
--
---- Cập nhật cột PHAI: Không thành công
--CONN NV401/NV401@//localhost:1521/PDB_N09;
--UPDATE N09_ADMIN.N09_NHANSU SET PHAI = 'Nam' WHERE MANV = 'NV401';
--/
...
--CONN NV201/NV201@//localhost:1521/PDB_N09;
---- UPDATE thành công
--UPDATE N09_ADMIN.N09_DANGKY SET DIEMTH = 10, DIEMQT = 10, DIEMCK = 10, DIEMTK = 10 WHERE MASV = 'SV001' AND MAHP = 'HP001' AND HK = 1 AND NAM = 2024 AND MACT = 'CQ';
--/
--
--CONN NV201/NV201@//localhost:1521/PDB_N09;
---- UPDATE KHÔNG thành công
--UPDATE N09_ADMIN.N09_DANGKY SET DIEMTH = 10, DIEMQT = 10, DIEMCK = 10, DIEMTK = 10 WHERE MASV = 'SV002' AND MAHP = 'HP001' AND HK = 2 AND NAM = 2024 AND MACT = 'CLC';
--/
--
--CONN NV201/NV201@//localhost:1521/PDB_N09;
---- UPDATE KHÔNG thành công
--UPDATE N09_ADMIN.N09_DANGKY SET HK = 3 WHERE MASV = 'SV001' AND MAHP = 'HP001' AND HK = 1 AND NAM = 2024 AND MACT = 'CQ';
--/
...
---- Cập nhật dữ liệu PHANCONG liên quan các học phần do “Văn phòng khoa” phụ trách: Thành công
--CONN NV301/NV301@//localhost:1521/PDB_N09;
--UPDATE N09_ADMIN.N09_PHANCONG SET NAM = 2079 WHERE MAGV = 'NV209' AND MAHP = 'HP032' AND HK = 2 AND NAM = 2024 AND MACT = 'CQ';
--/
...
--INSERT INTO N09_ADMIN.N09_DANGKY(MASV, MAGV, MAHP, HK, NAM, MACT) VALUES('SV001', 'NV202', 'HP002', 2, 2024, 'CLC');
--/
---- INSERT thành công
--INSERT INTO N09_ADMIN.N09_DANGKY(MASV, MAGV, MAHP, HK, NAM, MACT) VALUES('SV001', 'NV217', 'HP006', 3, 2024, 'CLC');
--/
----------
--CONN NV301/NV301@//localhost:1521/PDB_N09;
---- DELETE KHÔNG thành công
--DELETE FROM N09_ADMIN.N09_DANGKY WHERE MASV = 'SV001' AND MAGV = 'NV201' AND MAHP = 'HP001' AND HK = 1 AND NAM = 2024 AND MACT = 'CQ';
--/
---- DELETE thành công
--DELETE FROM N09_ADMIN.N09_DANGKY WHERE MASV = 'SV001' AND MAGV = 'NV217' AND MAHP = 'HP006' AND HK = 3 AND NAM = 2024 AND MACT = 'CLC';
--/
...
---- INSERT KHÔNG thành công
--CONN NV102/NV102@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_PHANCONG VALUES('NV205', 'HP002', 2, 2024, 'CLC');
--/
--
---- INSERT thành công
--CONN NV102/NV102@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_PHANCONG VALUES('NV220', 'HP003', 1, 2024, 'CQ');
--/
--
---- DELETE KHÔNG thành công
--CONN NV102/NV102@//localhost:1521/PDB_N09;
--DELETE FROM N09_ADMIN.N09_PHANCONG WHERE MAGV = 'NV202' AND MAHP = 'HP002' AND HK = 2 AND NAM = 2024 AND MACT = 'CLC';
--/
--
--CONN NV102/NV102@//localhost:1521/PDB_N09;
---- DELETE thành công
--DELETE FROM N09_ADMIN.N09_PHANCONG WHERE MAGV = 'NV220' AND MAHP = 'HP003' AND HK = 1 AND NAM = 2024 AND MACT = 'CQ';
--/
...
--CONN NV001/NV001@//localhost:1521/PDB_N09;
--UPDATE N09_ADMIN.N09_NHANSU SET DT = '0987654321' WHERE MANV = 'NV001';
--/
...
--CONN NV001/NV001@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_PHANCONG VALUES('NV210', 'HP004', 3, 2024, 'CQ');
--/
--
---- Xóa dữ liệu trên quan hệ PHANCONG: Không thành công
---- Giải thích: Như trên
--CONN NV001/NV001@//localhost:1521/PDB_N09;
--DELETE FROM N09_ADMIN.N09_PHANCONG WHERE MAGV = 'NV210' AND MAHP = 'HP004';
--/
--
---- Thêm dữ liệu vào quan hệ PHANCONG: Thành công
---- Giải thích: Học phần HP001 thuộc DV001 nên có thể thực hiện thao tác INSERT
--CONN NV001/NV001@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_PHANCONG (MAGV, MAHP, HK, NAM, MACT) VALUES ('NV210', 'HP001', 1, 2024, 'CQ');
--/
--
...
--CONN NV001/NV001@//localhost:1521/PDB_N09;
--DELETE FROM N09_ADMIN.N09_PHANCONG WHERE MAGV = 'NV210' AND MAHP = 'HP001';
--/
--
...
BEFORE UPDATE ON N09_ADMIN.N09_SINHVIEN
FOR EACH ROW
BEGIN
...
GRANT SELECT, UPDATE ON N09_ADMIN.N09_SINHVIEN TO N09_RL_SINHVIEN;
/
...
GRANT SELECT ON N09_ADMIN.N09_KHMO TO N09_RL_SINHVIEN;
/
...
GRANT SELECT ON N09_ADMIN.N09_HOCPHAN TO N09_RL_SINHVIEN;
/
...
GRANT SELECT ON N09_ADMIN.N09_DANGKY TO N09_RL_SINHVIEN;
...
GRANT UPDATE ON N09_ADMIN.N09_DANGKY TO SV001;
/
...
GRANT INSERT, DELETE ON N09_ADMIN.N09_DANGKY TO N09_RL_SINHVIEN;
/
...
--CONN SV001/SV001@//localhost:1521/PDB_N09;
--DELETE FROM N09_ADMIN.N09_DANGKY WHERE MASV = 'SV001' AND MAHP = 'HP003' AND MAGV = 'NV201' AND HK = 3 AND NAM = 2024;
--/
--
---- Xóa Học phần HP001, Học kỳ 1, Năm 2024 (1/1/2024), Ngày hiện tại 10/6/2024: Không thành công
--CONN SV001/SV001@//localhost:1521/PDB_N09;
--DELETE FROM N09_ADMIN.N09_DANGKY WHERE MASV = 'SV001' AND MAHP = 'HP001' AND MAGV = 'NV201' AND HK = 1 AND NAM = 2024;
--/
--
---- Thêm Học phần HP003, Học kỳ 3, Năm 2024 (1/9/2024), Ngày hiện tại 10/6/2024: Thành công
--CONN SV001/SV001@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_DANGKY VALUES('SV001', 'NV201', 'HP003', 3, 2024, 'CQ', NULL, NULL, NULL, NULL);
--/
--
---- Thêm Học phần HP001, Học kỳ 1, Năm 2024 (1/1/2024), Ngày hiện tại 10/6/2024: Không thành công
--CONN SV001/SV001@//localhost:1521/PDB_N09;
--INSERT INTO N09_ADMIN.N09_DANGKY VALUES('SV001', 'NV202', 'HP001', 2, 2024, 'CLC', NULL, NULL, NULL, NULL);
--/
