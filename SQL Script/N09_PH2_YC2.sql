...
BEGIN
    ...
    -- Label: Truong Don Vi 6 - KHMT - CS1
    SA_USER_ADMIN.SET_USER_LABELS(
        policy_name => 'N09_POLICY_THONGBAO',
        user_name   => 'NV106',
        max_read_label => 'TDONVI:KHMT:CS1');
END;
/
...
-- Test Trưởng đơn vị NV106 - KHMT - CS1 (đọc thành công: 4 dòng)
...
-- Test Trưởng đơn vị NV106 - KHMT - CS1 (đọc thành công: 2 dòng KHMT, 2 dòng ALL lĩnh vực)
CONN NV106/NV106@//localhost:1521/PDB_N09;
SELECT * FROM N09_ADMIN.N09_THONGBAO
WHERE NGUOINHAN = 'TRUONG DON VI';
/
