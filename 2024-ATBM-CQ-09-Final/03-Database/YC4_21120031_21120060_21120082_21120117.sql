...
-- Bảng N09_ADMIN.N09_NHANSU
-- Bảng N09_ADMIN.N09_DANGKY
-- Bảng N09_ADMIN.N09_KHMO

-- Kích hoạt ROW MOVEMENT
ALTER TABLE N09_ADMIN.N09_NHANSU ENABLE ROW MOVEMENT; 
ALTER TABLE N09_ADMIN.N09_DANGKY ENABLE ROW MOVEMENT; 
ALTER TABLE N09_ADMIN.N09_KHMO ENABLE ROW MOVEMENT; 
/

-- NOTE: Chạy dưới người dùng N09_ADMIN
...
IS
BEGIN
    EXECUTE IMMEDIATE 'FLASHBACK TABLE N09_ADMIN.N09_DANGKY TO TIMESTAMP TO_TIMESTAMP(:1,''dd-MON-YY hh24:MI:SS'')'
    USING TIME;
END;
/
...
IS
BEGIN
    EXECUTE IMMEDIATE 'FLASHBACK TABLE N09_ADMIN.N09_NHANSU TO TIMESTAMP TO_TIMESTAMP(:1,''dd-MON-YY hh24:MI:SS'')'
    USING TIME;
END;
/
...
IS
BEGIN
    EXECUTE IMMEDIATE 'FLASHBACK TABLE N09_ADMIN.N09_KHMO TO TIMESTAMP TO_TIMESTAMP(:1,''dd-MON-YY hh24:MI:SS'')'
    USING TIME;
END;
/
...
--UPDATE N09_ADMIN.N09_DANGKY SET DIEMQT = 8 WHERE MASV = 'SV004';
