CREATE OR REPLACE PROCEDURE N09_SELECT_DBA_ROLES(OUTPUT OUT SYS_REFCURSOR)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE N09_SELECT_DBA_ROLE_PRIVS(OUTPUT OUT SYS_REFCURSOR)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE N09_SELECT_ALL_USERS(OUTPUT OUT SYS_REFCURSOR)
AS
BEGIN
...
conn KH1/KH1;
VARIABLE rc REFCURSOR;
EXECUTE SYS.N09_SELECT_USER_OR_ROLE_PRIVS_SIMPLIFY(:rc, 'KH1');
PRINT rc;
...
EXEC N09_CREATE_ROLE('HELLOWORLD');
DROP ROLE HELLOWORLD;
...
EXEC N09_GRANT_PRIVILEGE('SELECT', 'HUYP', NULL, 'UV_N09_HOADONNHAPHANG');
...
EXEC N09_REVOKE_PRIVILEGE('SELECT', 'HUYP', 'UV_N09_HOADONNHAPHANG');
