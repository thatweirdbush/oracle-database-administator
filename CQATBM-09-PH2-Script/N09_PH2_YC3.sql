...
AUDIT ALL ON C##ADMIN.N09_NHANSU BY ACCESS WHENEVER SUCCESSFUL;
AUDIT UPDATE, DELETE ON C##ADMIN.N09_DANGKY BY ACCESS;
AUDIT SELECT ON C##ADMIN.N09_SINHVIEN BY ACCESS;
...
AUDIT EXECUTE ON C##ADMIN.N09_POLICY_FUNCTION_INSERT_DELETE_DANGKY BY ACCESS;
AUDIT EXECUTE ON C##ADMIN.N09_POLICY_FUNCTION_UPDATE_DANGKY BY ACCESS;
/
...
--
--CONN NV201/NV201;
--UPDATE C##ADMIN.N09_DANGKY SET DIEMTH = 8 WHERE MASV = 'SV001';
